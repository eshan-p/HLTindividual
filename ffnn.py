...
class FFNN(nn.Module):
    ...
    def forward(self, input_vector):
        ...
        linearize = self.W1(input_vector)                       # pass input vector through first linear layer W1
        hidden_layer = self.activation(linearize)               # and then apply ReLU function to that tensor
